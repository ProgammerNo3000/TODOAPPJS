...
function renderItem(item, index) {
  ...
  task_done_el.classList.add("fa");
task_done_el.classList.add("fa-check");
  ...
  task_edit_el.classList.add("fa-pencil");
  ...
  task_edit_el.addEventListener("click", (e) => {
    if (task_edit_el.classList.contains("fa-pencil")) {
      // task_edit_el.innerText = "Save";
      task_edit_el.classList.add("fa");
      task_edit_el.classList.add("fa-floppy-disk");
